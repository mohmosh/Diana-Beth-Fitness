...
// // Auth routes
// Route::get('/login-another', [AuthController::class, 'showLoginForm'])->name('login.form-another');

// Route::post('login-another', [AuthController::class, 'login'])->name('login-another');

// Route::get('register-another', function () {
//     return view('auth.register'); // Registration form view
// })->name('register.form-another');
// Route::post('register-another', [RegisterController::class, 'register'])->name('register-another');
