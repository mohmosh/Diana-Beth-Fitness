...
<body>
    ...
    <div class="container">
        <!-- Cancel Button -->
        <button onclick="window.history.back();" style="position: absolute; top: 20px; right: 300px; background-color: white; color: black; border: 1px solid #ccc; padding: 10px 20px;">Cancel</button>
