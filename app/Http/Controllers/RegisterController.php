...
class RegisterController extends Controller
{
    ...
    public function register(RegisterUserRequest $request)
    {
        ...
        try {
            ...
            // Redirect with success message and a link to home
            return redirect()->route('email.confirmation')->with(
                'success',
                'Subscription Successful!! A confirmation email has been sent to your email address. Please verify your email to access your dashboard.
                <br><br> <a href="' . route('home') . '" class="btn btn-primary">Go to Home</a>'
            );
        } catch (\Exception $e) {
